...
export const teamApi = {
  async signup(data: { username: string; email: string; full_name: string; password: string }) {
  ...
  async createTeam(team_name: string, specialization?: string, description?: string) {
  ...
  async searchFiles(query: string, workspace_type: string, team_id?: string, limit = 10) {
