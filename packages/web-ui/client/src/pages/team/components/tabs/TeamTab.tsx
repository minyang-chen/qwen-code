        ...
        <div className="border-b border-gray-200">
          <nav className="flex -mb-px">
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${teamSubTab === 'my-teams' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              My Teams
            </button>
            <button
              onClick={() => setTeamSubTab('all-teams')}
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${teamSubTab === 'all-teams' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              All Teams
            </button>
            <button
              onClick={() => setTeamSubTab('notifications')}
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${teamSubTab === 'notifications' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              Notifications
            </button>
          </nav>
                ...
                {myTeams.length > 0 ? (
                  myTeams.map((team) => (
                    <div
                      ...
                      className={`relative p-5 border-2 rounded-lg cursor-pointer transition-all hover:shadow-md ${selectedTeam?.id === team.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'}`}
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${team.role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'}`}
                        >
                          {team.role}
                        </span>
                      </div>
                      ...
                      {team.role === 'admin' && (
                        <button
                          ...
                          className="w-full mt-2 px-3 py-1.5 text-xs bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"
                        >
                          Delete Team
                        </button>
                      )}
            ...
            <div>
              <div className="flex gap-3 mb-6">
                <button
                  ...
                  className={`flex-1 px-6 py-3 text-sm font-medium rounded-lg transition-colors ${teamActionTab === 'create' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  Create Team
                </button>
                <button
                  onClick={() => setTeamActionTab('join')}
                  className={`flex-1 px-6 py-3 text-sm font-medium rounded-lg transition-colors ${teamActionTab === 'join' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                >
                  Join Team
                </button>
              </div>
